...
pmiPW = pd.read_csv('dialign+original pipeline/pmi-albanoRomance-pw.csv', index_col=0)
pmiSW = pd.read_csv('sw+original pipeline/pmi-albanoRomance-sw.csv', index_col=0)
