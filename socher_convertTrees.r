...
t1 <- read.nexus('socher_albanoRomance.run1.t')
write.tree(t1,'socher_albanoRomance.run1.tre')

t2 <- read.nexus('socher_albanoRomance.run2.t')
write.tree(t2,'socher_albanoRomance.run2.tre')
